  ...
  const partners: Partner[] = [
    {
      ...
      typeId: 'Klien Enterprise',
      image: '/assets/partners/partner1.jpg',
      description: 'Leading technology solutions provider',
      descriptionId: 'Penyedia solusi teknologi terkemuka',
      icon: 'building',
    },
    {
      name: 'Digital Marketing Pro',
      type: 'Agency Partner',
      typeId: 'Partner Agency',
      image: '/assets/partners/partner2.jpg',
      description: 'Full-service digital marketing agency',
      descriptionId: 'Agency pemasaran digital layanan lengkap',
      icon: 'users',
    },
    {
      name: 'Startup Ventures',
      type: 'Startup Client',
      typeId: 'Klien Startup',
      image: '/assets/partners/partner3.png',
    ...
    },
    {
      ...
      typeId: 'Partner Korporat',
      image: '/assets/partners/partner4.png',
      description: 'International business solutions',
      descriptionId: 'Solusi bisnis internasional',
      icon: 'building',
    },
  ];
