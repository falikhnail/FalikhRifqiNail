  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: Github,
      url: 'https://github.com/falikhnail',
    ...
    },
    {
      name: 'LinkedIn',
      icon: Linkedin,
      url: 'https://linkedin.com/in/falikhrifqinail',
    ...
    },
    {
      name: 'Instagram',
      icon: Instagram,
      url: 'https://instagram.com/falikhnail',
    ...
    },
    {
      name: 'Facebook',
      icon: Facebook,
      url: 'https://facebook.com/falikhnail',
